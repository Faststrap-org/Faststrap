...
def cart_content():
    ...
    return Div(
        ...
        Row(
            Col(
                A(Button("Continue Shopping", variant="outline-secondary"), href="/"), span=12, md=6
            ),
            Col(
                Card(
                    H4("Order Summary"),
                ...
                Card(
                    ...
                    Form(
                        Row(
                            ...
                            Col(
                                Input("last_name", label="Last Name", required=True), span=12, md=6
                            ),
                        ),
                        ...
                        Row(
                            Col(Input("city", label="City", required=True), span=12, md=6),
                            Col(Input("state", label="State", required=True), span=12, md=3),
                            Col(Input("zip", label="ZIP Code", required=True), span=12, md=3),
                        ),
