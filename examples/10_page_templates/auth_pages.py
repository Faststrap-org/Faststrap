...
def login_page():
    ...
    return AuthLayout(
        FormGroup(
            Input("email", input_type="email", placeholder="you@example.com", required=True),
            label="Email Address",
            required=True,
        ),
        FormGroup(
            Input("password", input_type="password", placeholder="********", required=True),
            label="Password",
            required=True,
        ),
        Checkbox("remember", label="Remember me", checkbox_id="remember", cls="mb-3"),
...
def register_page():
    ...
    return AuthLayout(
        FormGroup(
            Input("name", placeholder="John Doe", required=True),
            label="Full Name",
            required=True,
        ),
        FormGroup(
        ...
        FormGroup(
            Input("confirm_password", input_type="password", placeholder="********", required=True),
